...
object Deserializers {
  ...
  def deserializeUpdate(
    bytes: Array[Byte]
  ): Either[Throwable, InsuranceUpdate] =
    deserialize[InsuranceUpdate](bytes)

  def deserializeState(
    bytes: Array[Byte]
  ): Either[Throwable, InsuranceOnChainState] =
    deserialize[InsuranceOnChainState](bytes)
  ...
  def deserializeCalculatedState(
    bytes: Array[Byte]
  ): Either[Throwable, InsuranceCalculatedState] =
    deserialize[InsuranceCalculatedState](bytes)
}