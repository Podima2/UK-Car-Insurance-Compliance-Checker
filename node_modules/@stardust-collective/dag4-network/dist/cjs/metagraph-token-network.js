...
exports.MetagraphTokenNetwork = void 0;
const data_l1_api_1 = require("./api/metagraph-token/data-l1-api");
const l0_api_1 = require("./api/metagraph-token/l0-api");
const l1_api_1 = require("./api/metagraph-token/l1-api");
const block_explorer_api_1 = require("./api/v2/block-explorer-api");
class MetagraphTokenNetwork {
    constructor(netInfo) {
        this.connectedNetwork = netInfo;
        this.l0Api = new l0_api_1.MetagraphTokenL0Api(netInfo.l0Url);
        this.l1Api = new l1_api_1.MetagraphTokenL1Api(netInfo.l1Url);
        this.dl1Api = netInfo.dl1Url ? new data_l1_api_1.MetagraphTokenDataL1Api(netInfo.dl1Url) : null;
        this.beApi = new block_explorer_api_1.BlockExplorerV2Api(netInfo.beUrl);
    }
    getNetwork() {
...
exports.MetagraphTokenNetwork = MetagraphTokenNetwork;
