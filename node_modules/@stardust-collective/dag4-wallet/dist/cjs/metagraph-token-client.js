...
class MetagraphTokenClient {
    ...
    createAllowSpend(body, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, operations_1.allowSpend)(bodyWithCurrencyId, this.network, this.account.keyTrio, params);
        });
    }
    createTokenLock(body, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bodyWithCurrencyId = Object.assign(Object.assign({}, body), { currencyId: this.networkInfo.metagraphId });
            return (0, operations_1.tokenLock)(bodyWithCurrencyId, this.network, this.account.keyTrio, params);
        });
    }
