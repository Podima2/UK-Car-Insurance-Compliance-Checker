...
exports.keyStore = exports.KeyStore = exports.DATA_SIGN_PREFIX = exports.PERSONAL_SIGN_PREFIX = exports.DERIVATION_PATH = void 0;
...
exports.PERSONAL_SIGN_PREFIX = `\u0019Constellation Signed Message:\n`;
exports.DATA_SIGN_PREFIX = `\u0019Constellation Signed Data:\n`;
class KeyStore {
    sha512(hash) {
    ...
    decryptPrivateKey(jKey, password) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isValidJsonPrivateKey(jKey)) {
                const wallet = yield ethereumjs_wallet_1.default.fromV3(jKey, password);
    ...
    sign(privateKey, msg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (useFallbackLib) {
                ...
                return buffer_1.Buffer.from(ecSig.toDER()).toString('hex');
            }
            const sig = yield secp.sign(sha512Hash, privateKey);
            return buffer_1.Buffer.from(sig).toString('hex');
        });
    }
    personalSign(privateKey, msg) {
        return __awaiter(this, void 0, void 0, function* () {
            const message = `${exports.PERSONAL_SIGN_PREFIX}${msg.length.toString()}\n${msg}`;
            return this.sign(privateKey, message);
        });
    }
    serialize(msg) {
        return buffer_1.Buffer.from(msg, "utf-8").toString("hex");
    }
    dataSign(privateKey, msg) {
        return __awaiter(this, void 0, void 0, function* () {
            const message = `${exports.DATA_SIGN_PREFIX}${msg.length.toString()}\n${msg}`;
            const serializedMessage = this.serialize(message);
            const hash = this.sha256(buffer_1.Buffer.from(serializedMessage, "hex"));
    ...
    verify(publicKey, msg, signature) {
        const sha512Hash = this.sha512(msg);
        if (useFallbackLib) {
            return curve.verify(sha512Hash, signature, buffer_1.Buffer.from(publicKey, 'hex'));
        }
        return secp.verify(signature, sha512Hash, publicKey);
    }
    verifyData(publicKey, msg, signature) {
    ...
    getPublicKeyFromPrivate(privateKey, compact = false) {
        ...
        return buffer_1.Buffer.from(secp.getPublicKey(privateKey, compact)).toString('hex');
    }
    ...
    generateTransactionWithHash(amount, toAddress, keyTrio, lastRef, fee = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signature = yield this.sign(privateKey, hash);
    ...
    brotliCompress(body) {
        return __awaiter(this, void 0, void 0, function* () {
            const normalized = (0, utils_1.normalizeObject)(body);
            const compressed = yield (0, utils_1.serializeBrotli)(body);
